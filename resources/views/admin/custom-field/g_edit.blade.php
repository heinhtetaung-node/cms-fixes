...
@section('content')
      <div id="content" class="bodylayout">
        <div class="panel panel-default">
          <div class="panel-heading"><i class="fa fa-list-ul"></i> Custom Field Edit</div>
            <div class="panel-body">
              <form class="form-horizontal" role="form" method="POST" action="{{route('admin.custom_field.g_update',$acf_group->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group{{ $errors->has('cf_type1') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group{{ $errors->has('cf_name5') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control cf_name5"  name="cf_name5" value="{{$acf_group->cf_name5}}" required>@if ($errors->has('cf_name5'))
                                    <span class="help-block">
